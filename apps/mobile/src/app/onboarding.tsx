      ...
      <Screen safeArea>
        ...
        >
          ...
          <Card style={{ gap: 14 }}>
            ...
            <Muted>
              Connect to your SIMBridge backend. Messages are end-to-end
              encrypted on this device the server only relays ciphertext.
            </Muted>
            <View>
              <Muted style={{ marginBottom: 6 }}>Phone number</Muted>
              <Input
                value={name}
            ...
            {error ? (
              <Muted style={{ color: colors.red }}>{error}</Muted>
            ) : null}
            <Button
              label="Continue"
            ...
            <Row style={{ flexWrap: 'wrap', gap: 6 }}>
              {[
                ...
                <View
                  ...
                  style={styles.chip}
                >
                  <Text style={{ color: colors.accentSoft, fontSize: 11 }}>
                    ✓ {b}
                  </Text>
                </View>
              ))}
